...
const renderItem = ($container, item) => {
  ...
  $row.append('<div class="name">' +
    ...
    '<span style="color: ' + item.color + ';"><a href="https://steamcommunity.com/market/listings/' + item.hashmarket + '" title="' + name + '" target="_blank">' + name + '</a></span><br>' +
...
const createItemUrl = ({appid, hashmarket}, currency) => {
  const name = hashmarket.substring(hashmarket.indexOf('/') + 1);
