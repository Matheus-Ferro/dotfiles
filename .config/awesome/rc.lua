...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "h", function () awful.util.spawn( "htop" ) end,
        {description = "htop (Task Manager)" , group = "1- Programs" }),
 ...
 -- Show/Hide Systray
    ...
    awful.key({ altkey, "Control" }, "Right", function () lain.util.useless_gaps_resize(1) end,
              {description = "Increment Useless Gaps", group = "0- Window Manager"}),
    awful.key({ altkey, "Control" }, "Left", function () lain.util.useless_gaps_resize(-1) end,
