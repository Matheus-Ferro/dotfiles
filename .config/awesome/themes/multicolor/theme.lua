...
theme.taglist_font                              = "JetBrainsMono NF 13"
...
theme.layout_centerfair                         = theme.confdir .. "/icons/magnifier.png"
theme.layout_centerwork                         = theme.confdir .. "/icons/magnifier.png"
theme.layout_termfair                           = theme.confdir .. "/icons/max.png"
...
local mytextclock = wibox.widget.textclock(markup("#7788af", "%A %d %B ") .. markup("#535f7a", ">") .. markup("#FFD600", " %H:%M "))
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "JetBrainsMono NF 10", fg = theme.fg_normal },
...
local temp = lain.widget.temp({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#FFD600", coretemp_now .. "°C "))
    end
})
...
local memory = lain.widget.mem({
    settings = function()
        widget:set_markup(markup.fontfg(theme.font, "#FFD600", mem_now.used .. "M "))
    end
})
   ...
   s.quake = lain.util.quake({ app = "urxvt", height = 0.50, argname = "--name %s" })
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            cpu.widget,
            weather_widget({
                coordinates = {-15.2326492,-59.3349996},
